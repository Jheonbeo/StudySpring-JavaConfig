	...
	<div id="wrapper">
		...
		<ul
			...
			<a
				...
				<div class="sidebar-brand-text mx-3 routes"
			...
			<li class="nav-item"><a class="nav-link" id="dashboard-icon">
					...
					route="/pages/about.html">Dashboard</span>
			</a></li>
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				<div id="collapsePages" class="collapse"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" v-bind:href="warehouse">-</a>
						<div class="collapse-divider"></div>
						<h6 class="collapse-header">출고:</h6>
						<a class="collapse-item" v-on:click="identificationView">식별지</a>
					</div>
				</div></li>
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				<div id="collapseProd" class="collapse"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" id="inspection" href="">검사정보 조회</a> <a
							class="collapse-item" href="">하드웨어 조회</a>
					</div>
				</div></li>
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				<div id="collapsePart" class="collapse"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" v-bind:href=item_list>조회 및 수정</a> <a
							class="collapse-item" v-bind:href=item_register>등록</a>
					</div>
				</div></li>
					...
					<ul class="navbar-nav ml-auto">
						<li class="nav-item dropdown no-arrow"><a
							...
							aria-expanded="false"> <span
								class="mr-2 d-none d-lg-inline text-gray-600 small">jheonbeo</span>
